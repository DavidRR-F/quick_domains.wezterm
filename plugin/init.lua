...
local function get_require_path()
  local path1 = 'httpssCssZssZsgithubsDscomsZsDavidRR-FsZsquick_domainssDswezterm'
  local path2 = 'httpssCssZssZsgithubsDscomsZsDavidRR-FsZsquick_domainssDsweztermZs'
